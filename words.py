...
def readfile(filename, picpath, type):
	...
	if draw == 'flower':
		dataset = obtain_flower_dataset(totalsides = 6, inner_radius = 3.5, out_radius = 5)
...
def main():
	readfile('words.txt', '/Users/lxb/Documents/yyc/scripts/booksproject/ifgiveamouseacookie/', 1)
